...
import { ChatsResponse } from '../models/chats-response';
...
export class ChatService extends BaseService {
  ...
  static readonly GetChatsByReceiverPath = '/api/vi/chats';
   ...
   */
  getChatsByReceiver$Response(params?: GetChatsByReceiver$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ChatsResponse>>> {
   ...
   * This method doesn't expect any request body.
   */
  getChatsByReceiver(params?: GetChatsByReceiver$Params, context?: HttpContext): Observable<Array<ChatsResponse>> {
    return this.getChatsByReceiver$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<ChatsResponse>>): Array<ChatsResponse> => r.body)
    );
  }

  /** Path part for operation `createChat()` */
  static readonly CreateChatPath = '/api/vi/chats';
