...
import { savedMessage } from '../fn/message/saved-message';
import { SavedMessage$Params } from '../fn/message/saved-message';
...
export class MessageService extends BaseService {
  ...
  /** Path part for operation `savedMessage()` */
  static readonly SavedMessagePath = '/api/v1/messages';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `savedMessage()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  savedMessage$Response(params: SavedMessage$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
    return savedMessage(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `savedMessage$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  savedMessage(params: SavedMessage$Params, context?: HttpContext): Observable<void> {
    return this.savedMessage$Response(params, context).pipe(
